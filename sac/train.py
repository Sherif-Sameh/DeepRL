...
class SACTrainer:
    ...
    def __update_params(self, ac: MLPActorCritic, alpha_mod: AlphaModule, buf: ReplayBuffer, 
                        ...
                        writer: SummaryWriter, epoch, gamma, polyak, alpha_min, 
                        entropy_target, update_alpha=True):
    ...
    def train_mod(self, env_fn, model_path='', ac=MLPActorCritic, ac_kwargs=dict(), 
                  ...
                  gamma=0.99, polyak=0.995, lr=3e-4, alpha=0.2, alpha_min=3e-3,
                  entropy_target=None, auto_alpha=True, batch_size=400, 
                ...
                if (buf.get_buffer_size() >= learning_starts) \
                    ...
                    for _ in range(update_every):
                        self.__update_params(ac_mod, alpha_mod, buf, pi_optim, 
                                             ...
                                             writer, epoch, gamma, polyak, 
                                             alpha_min, entropy_target, 
