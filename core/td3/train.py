...
class TD3Trainer:
    ...
    :param target_noise: Standard deviation of noise sampled and added to target actions for
        critic's loss calculation.
    :param noise_clip: Noise sampled and added to target actions is clipped to the range of 
        [-noise_clip, noise_clip] 
    :param policy_delay: Number of critic updates per an update to the actor.
    ...
    def __init__(self, env_fn, wrappers_kwargs=dict(), use_gpu=False, model_path='', 
                 ...
                 update_every=50, num_updates=-1, target_noise=0.2, noise_clip=0.5, 
                 policy_delay=2, num_test_episodes=10, seq_len=80, seq_prefix=40, 
