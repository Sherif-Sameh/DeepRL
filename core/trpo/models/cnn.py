...
class CNNActorCritic(nn.Module):
    def __init__(self, env: VectorEnv, in_channels, out_channels, kernel_sizes, 
        ...
        feature_ext_actor = FeatureExtractor(obs_dim, in_channels, out_channels, kernel_sizes, 
                                             strides, padding, features_out)
        ...
        if isinstance(env.single_action_space, Discrete):
            ...
            self.actor = CNNActorContinuous(feature_ext_actor, act_dim, 
                                            log_std_init)
        else:
        ...
        feature_ext_critic = FeatureExtractor(obs_dim, in_channels, out_channels, kernel_sizes, 
                                              strides, padding, features_out)
