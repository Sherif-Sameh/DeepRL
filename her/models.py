...
class MLPActorCriticTD3(nn.Module):
    def __init__(self, env: gym.Env, goal_dim, hidden_sizes_actor, 
                 hidden_sizes_critic, hidden_acts_actor, hidden_acts_critic, 
                 action_std):
        super().__init__()
        ...
        if isinstance(env.action_space, Box):
            ...
            self.actor = MLPActorTD3(obs_dim + goal_dim, act_dim, hidden_sizes_actor, 
                                     hidden_acts_actor, self.action_max)
        else:
            raise NotImplementedError
        
        # Initialize the two critics
        self.critic_1 = MLPCriticTD3(obs_dim + goal_dim, act_dim, hidden_sizes_critic,
                                     hidden_acts_critic)
        self.critic_2 = MLPCriticTD3(obs_dim + goal_dim, act_dim, hidden_sizes_critic,
                                     hidden_acts_critic)
