...
class PPOTrainer:
    ...
    def __update_params(self, ac_mod: MLPActorCritic, buf: PPOBuffer, pi_optim: Adam, 
                        val_optim: Adam, writer: SummaryWriter, epoch, train_pi_iters, 
                        train_v_iters, clip_ratio, target_kl):
    ...
    def train_mod(self, env_fn, model_path='', ac=MLPActorCritic, ac_kwargs=dict(), seed=0,
        ...
        for epoch in range(epochs):
            ...
            self.__update_params(ac_mod, buf_mod, pi_optim, val_optim, writer, epoch,
...
if __name__ == '__main__':
    ...
    trainer.train_mod(env_fn, model_path=args.model_path, ac=MLPActorCritic, 
                      ...
                      batch_size=args.batch_size, epochs=args.epochs, gamma=args.gamma, 
                      clip_ratio=args.clip_ratio, pi_lr=args.pi_lr, vf_lr=args.vf_lr, 
                      train_pi_iters=args.train_pi_iters, train_v_iters=args.train_v_iters, 
                      lam=args.lam, target_kl=args.target_kl, log_dir=log_dir, 
